...
final class ModelData: ObservableObject {
    ...
    // Returns the URL of the file on disk that our app uses to store its state to persist across app sessions.
    private static func fileURL() throws -> URL {
        try FileManager.default.url(for: .documentDirectory, in: .userDomainMask, appropriateFor: nil, create: false).appendingPathComponent("tasks.data")
    }
    
    // loading data from this file into our tasks array
    ...
    // storing our dynamic tasks array to disk
